...
namespace Hotel_Management_System.customerDataSetTableAdapters {
...
SELECT CID, Cname, Mobile, Nationality, Gender, DOB, IDProof, CAddress, CheckIn, CheckOut, ChekOut, RoomID FROM Customer WHERE (CID = @CID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@D", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Gender", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(customerDataSet.CustomerDataTable dataTable, string D) {
        ...
        public virtual customerDataSet.CustomerDataTable GetData(string D) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((D == null)) {
                throw new global::System.ArgumentNullException("D");
            }
