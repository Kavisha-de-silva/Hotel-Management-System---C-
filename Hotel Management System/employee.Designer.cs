...
namespace Hotel_Management_System.employeeTableAdapters {
...
SELECT EID, EName, Mobile, Gender, Email, Username, Pass FROM Employee WHERE (EID = @EID)";
        ...
        public virtual int Fill(employee.EmployeeDataTable dataTable, string a) {
        ...
        public virtual employee.EmployeeDataTable GetData(string a) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((a == null)) {
                throw new global::System.ArgumentNullException("a");
            }
