...
namespace Hotel_Management_System.customerDataTableAdapters {
...
SELECT CID, Cname, Mobile, Nationality, Gender, DOB, IDProof, CAddress, CheckIn, CheckOut, ChekOut, RoomID FROM Customer WHERE (CID = @CID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@b", global::System.Data.SqlDbType.VarChar, 250, global::System.Data.ParameterDirection.Input, 0, 0, "Cname", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(customerData.CustomerDataTable dataTable, string b) {
        ...
        public virtual customerData.CustomerDataTable GetData(string b) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((b == null)) {
                throw new global::System.ArgumentNullException("b");
            }
